    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id)
          .field('id,title,subtitle,shipFrom,categoryId,categoryIds,cover,images,rating,heat,tags,features,desc,detailImages,skus,isNew,isHot,onSale')
          .get().then(async (res) => {
